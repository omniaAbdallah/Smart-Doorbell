...
public class UnlockFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rec = (RecyclerView) v.findViewById(R.id.unlocklistHistory);
        Log.e(" 3- ", "get rec :");
...
//        ip = "192.168.1.4:5005";
        url = "http://" + ip + "/show_history/unlock".trim();
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        AdpterListHistory adpterListHistoryunlock = new AdpterListHistory(getContext(), unlock, ip);
                        Log.e(" 4- ", "create adpter : ip =" + ip);

                        Toast.makeText(getContext(), "list size : " + unlock.size(), Toast.LENGTH_LONG).show();

                        rec.setAdapter(adpterListHistoryunlock);
