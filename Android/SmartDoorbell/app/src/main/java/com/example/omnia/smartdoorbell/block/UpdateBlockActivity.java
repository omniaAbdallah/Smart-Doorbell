...
public class UpdateBlockActivity extends AppCompatActivity {
    EditText edit_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_name=(EditText) findViewById(R.id.block_edit_name);
        edit_image=(ImageView) findViewById(R.id.block_imageView);
//
//
...
//
    ...
    public void update(final Bitmap bitmap, final String nam, final String id) {
        ...
        VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, url1,
                    ...
                    public void onResponse(NetworkResponse response) {
                        try {
                            ...
                            if (object.getString("state").equals("ok")) {
                                Toast.makeText(UpdateBlockActivity.this, "success", Toast.LENGTH_LONG).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Log.e(" error ", error + "");
                Toast.makeText(UpdateBlockActivity.this, "no internetConnection" + error, Toast.LENGTH_LONG).show();
