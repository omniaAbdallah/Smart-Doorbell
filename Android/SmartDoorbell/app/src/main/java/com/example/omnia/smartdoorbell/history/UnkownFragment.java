...
public class UnkownFragment extends Fragment {
    RecyclerView rec;
    List<history> unkown;
    String ip, url;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_unkown, container, false);
        Log.e(" 2- ", "on creat view fragment all  :");
        rec = (RecyclerView) v.findViewById(R.id.unkownlistHistory);
        Log.e(" 3- ", "get rec :");
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        unkown.add(history);
                        AdpterListHistory adpterListHistoryunkown = new AdpterListHistory(getContext(), unkown, ip);
                        Log.e(" 4- ", "create adpter : ip =" + ip);

                        Toast.makeText(getContext(), "list size : " + unkown.size(), Toast.LENGTH_LONG).show();

                        rec.setAdapter(adpterListHistoryunkown);
